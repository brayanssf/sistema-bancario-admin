...
public class AgenciaDao {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Teste de inserir agência: ");
        Agencia agencia = new Agencia (null, "1235", "Três Corações", "MG", "Av. Rei Pelé", "589", "37410000");
        ...
        agencias.forEach(ag -> System.out.println("Código: " + ag.getCodigoAgencia()));
        
        System.out.println("Teste buscar agencias por id");
        Agencia ag = agenciaDao.buscarAgenciaPorCodigoAgencia("11");
        System.out.println("Código: " + ag.getCodigoAgencia());
    }
}
